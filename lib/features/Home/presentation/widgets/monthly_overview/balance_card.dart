...
class _BalanceCardState extends State<BalanceCard> {
  ...
  Widget build(BuildContext context) {
    ...
    final day = cardDate != null ? DateFormat('dd').format(cardDate) : "--";

    final month = cardDate != null ? DateFormat('MMM').format(cardDate) : "--";

    final year = cardDate != null ? DateFormat('yyyy').format(cardDate) : "--";
