...
class FoodTrackingDetailScreen extends ConsumerStatefulWidget {
  final FoodCycle cycle;

  const FoodTrackingDetailScreen({super.key, required this.cycle});

  @override
  ConsumerState<FoodTrackingDetailScreen> createState() =>
      _FoodTrackingDetailScreenState();
}

class _FoodTrackingDetailScreenState extends ConsumerState<FoodTrackingDetailScreen> {
  @override
  void initState() {
    super.initState();

    WidgetsBinding.instance.addPostFrameCallback((_) {
      ref.read(mealEntryViewModelProvider).initialize(widget.cycle);
    });
  }
