...
class RecentActivityService {
  ...
  Future<void> addExpenseCycleCreated(
    ...
    try {
      ...
      debugPrint('[RecentActivityService] expense cycle created added ${card.id}');
    } catch (e, stack) {
      debugPrint('[RecentActivityService] expense cycle created add failed $e');
      debugPrint('$stack');
      rethrow;
    }
  }
  ...
  Future<void> updateExpenseCycle(
    ...
    try {
      ...
      debugPrint('[RecentActivityService] expense cycle updated ${card.id}');
    } catch (e, stack) {
      debugPrint('[RecentActivityService] expense cycle update failed $e');
      debugPrint('$stack');
      rethrow;
    }
  }
  ...
  Future<void> deleteExpenseCycle(
    ...
    try {
      ...
      debugPrint('[RecentActivityService] expense cycle deleted $cardId');
    } catch (e, stack) {
      debugPrint('[RecentActivityService] expense cycle delete failed $e');
      debugPrint('$stack');
      rethrow;
    }
  }
  ...
  Future<void> addExpenseItemCreated(
    ...
    try {
      await repository.addActivity(activity);
      debugPrint('[RecentActivityService] expense item added ${expense.id}');
    } catch (e, stack) {
      debugPrint('[RecentActivityService] expense item add failed $e');
      debugPrint('$stack');
      rethrow;
    }
  }
  ...
  Future<void> updateExpenseItem(
    ...
    try {
      await repository.updateActivity(activity);
      debugPrint('[RecentActivityService] expense item updated ${expense.id}');
    } catch (e, stack) {
      debugPrint('[RecentActivityService] expense item update failed $e');
      debugPrint('$stack');
      rethrow;
    }
  }
  ...
  Future<void> deleteExpenseItem(
    ...
    try {
      ...
      debugPrint('[RecentActivityService] expense item deleted $expenseId');
    } catch (e, stack) {
      debugPrint('[RecentActivityService] expense item delete failed $e');
      debugPrint('$stack');
      rethrow;
    }
  }
  ...
  String _formatSubtitle(ExpenseCardModel card) {
    final month = DateFormat('MMM yyyy').format(card.startDate);
  ...
  String _formatExpenseSubtitle(ExpenseModel expense) {
